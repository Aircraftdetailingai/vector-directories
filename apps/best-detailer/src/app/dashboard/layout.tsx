...
async function getDashboardData(userId: string): Promise<{
  ...
  try {
    ...
    const company = await getCompanyById(supabase, userProfile.company_id);
    return { userProfile, company };
  } catch {
    return {
      userProfile: {
        id: "00000000-0000-0000-0000-000000000099",
        email: "victoria@prestige-aviation.example.com",
...
export default async function DashboardLayout({
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <Header />
      <div className="flex-1 bg-ivory-50">
        {/* Hero */}
        <section className="bg-noir-900 py-10">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <h1 className="font-heading text-2xl font-semibold tracking-tight text-ivory-100 sm:text-3xl">
              Your Dashboard
            </h1>
