...
export const metadata: Metadata = {
  title: "Advertiser Dashboard | Best Aircraft Detailer",
  description: "Manage your ads on Best Aircraft Detailer.",
};
      ...
      <main className="flex-1 bg-ivory-50">
        <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="font-heading text-3xl font-bold text-noir-900 tracking-wide">
            ...
            <Link
              href="/advertise"
              className="bg-noir-900 px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-noir-800"
            >
              Create New Ad
            </Link>
          </div>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-3">
            <div className="border border-ivory-200 bg-white p-6">
              <p className="text-sm text-gray-600">Active Ads</p>
              <p className="mt-1 font-heading text-2xl font-bold text-noir-900">
          ...
          {/* Ads table */}
          <div className="mt-8 overflow-hidden border border-ivory-200 bg-white">
            {ads.length === 0 ? (
              <div className="p-12 text-center">
                <p className="text-gray-500">No ads yet.</p>
                <Link
                  href="/advertise"
                  className="mt-4 inline-block bg-noir-900 px-6 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-noir-800"
                >
              ...
              <table className="w-full text-left text-sm">
                ...
                <tbody className="divide-y divide-ivory-100">
                  {ads.map((ad: any) => (
                    <tr key={ad.id} className="hover:bg-ivory-50">
                      <td className="px-4 py-3 font-medium text-noir-900">{ad.title}</td>
