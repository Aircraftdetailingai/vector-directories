    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1 bg-ivory-50">
        <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          <Link
            href="/advertise"
            className="text-sm text-gold-600 hover:text-gold-700 tracking-widest uppercase"
          >
            &larr; Back to Placements
          </Link>

          <h1 className="mt-4 font-heading text-3xl font-bold text-noir-900 tracking-wide">
          ...
          <div className="mt-10 grid gap-10 lg:grid-cols-2">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="mt-1 block w-full border border-ivory-200 px-3 py-2 text-sm shadow-sm focus:border-gold-500 focus:outline-none focus:ring-1 focus:ring-gold-500"
                  />
                </div>
                ...
                <button
                  type="submit"
                  className="w-full bg-noir-900 px-4 py-3 text-sm font-semibold text-white transition-colors hover:bg-noir-800"
                >
                  Continue to Payment
                </button>
              </div>
            ...
            <div>
              ...
              <div className="mt-4 border border-ivory-200 bg-white p-4">
                <div className="flex aspect-[728/90] items-center justify-center bg-ivory-50 text-sm text-gray-400">
                  {imageUrl ? (
                    <img
                      src={imageUrl}
                      alt="Ad preview"
                ...
                <p className="mt-3 text-sm font-semibold text-noir-900">
