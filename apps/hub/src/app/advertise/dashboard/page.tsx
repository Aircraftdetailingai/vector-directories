...
export const metadata: Metadata = {
  title: "Advertiser Dashboard | Aviation Detailing Hub",
  description: "Manage your ads on Aviation Detailing Hub.",
};
      ...
      <main className="flex-1 bg-cream-50">
        <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <Link
              href="/advertise"
              className="rounded-full bg-coral-400 px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-coral-500"
            >
              Create New Ad
            </Link>
          </div>
          ...
          <div className="mt-8 overflow-hidden rounded-2xl border border-gray-200 bg-white">
            {ads.length === 0 ? (
              <div className="p-12 text-center">
                ...
                <Link
                  href="/advertise"
                  className="mt-4 inline-block rounded-full bg-coral-400 px-6 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-coral-500"
                >
