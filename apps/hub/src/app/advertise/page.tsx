...
export const metadata: Metadata = {
  title: "Advertise With Us | Aviation Detailing Hub",
  description:
    "Reach aircraft detailing decision-makers. Advertise on Aviation Detailing Hub.",
};
      ...
      <main className="flex-1">
        ...
        <section className="bg-teal-900 py-16 sm:py-24">
          <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-lg text-teal-200">
        ...
        {/* Stats */}
        <section className="border-b border-gray-200 bg-cream-50 py-12">
          <div className="mx-auto grid max-w-4xl grid-cols-1 gap-8 px-4 sm:grid-cols-3 sm:px-6 lg:px-8">
            {STATS.map((stat) => (
              <div key={stat.label} className="text-center">
                <p className="font-heading text-3xl font-bold text-teal-600">
                  {stat.value}
                </p>
        ...
        <section className="bg-cream-50 py-16">
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            <h2 className="font-heading text-center text-2xl font-bold text-teal-600">
            ...
            <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {PLACEMENTS.map((p) => (
                ...
                >
                  <h3 className="font-heading text-lg font-bold text-teal-700">
                    {p.name}
                  </h3>
                  <p className="mt-1 text-2xl font-bold text-coral-500">
                    {p.price}
                  </p>
                  ...
                  <Link
                    ...
                    className="mt-6 block rounded-full bg-coral-400 px-4 py-2.5 text-center text-sm font-semibold text-white transition-colors hover:bg-coral-500"
                  >
                    Get Started
                  </Link>
                </div>
        ...
        <section className="bg-white py-16">
          <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            ...
            <dl className="mt-10 space-y-8">
              {FAQS.map((faq) => (
                <div key={faq.q}>
                  <dt className="font-heading text-base font-semibold text-gray-900">
                    {faq.q}
                  </dt>
        ...
        <section className="bg-teal-600 py-16">
          <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
            ...
            <Link
              ...
              className="mt-8 inline-block rounded-full bg-coral-400 px-8 py-3 text-sm font-semibold text-white transition-colors hover:bg-coral-500"
            >
              Get Started Now
            </Link>
          </div>
