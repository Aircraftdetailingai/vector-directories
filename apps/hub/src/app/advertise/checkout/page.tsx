    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1 bg-cream-50">
        <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="mt-4 font-heading text-3xl font-bold text-teal-600">
          ...
          <div className="mt-10 grid gap-10 lg:grid-cols-2">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="mt-1 block w-full rounded-2xl border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-teal-500 focus:outline-none focus:ring-1 focus:ring-teal-500"
                  />
                </div>
                ...
                <button
                  type="submit"
                  className="w-full rounded-full bg-coral-400 px-4 py-3 text-sm font-semibold text-white transition-colors hover:bg-coral-500"
                >
                  Continue to Payment
                </button>
              </div>
            ...
            {/* Preview */}
            <div>
              <h2 className="font-heading text-lg font-semibold text-teal-600">
                Ad Preview
              </h2>
              <div className="mt-4 rounded-2xl border border-gray-200 bg-white p-4">
                <div className="flex aspect-[728/90] items-center justify-center rounded-xl bg-teal-50 text-sm text-teal-500">
                  {imageUrl ? (
                    <img
                      src={imageUrl}
                      alt="Ad preview"
