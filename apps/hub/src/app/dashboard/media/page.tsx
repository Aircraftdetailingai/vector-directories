...
export const metadata: Metadata = {
  title: "Photos & Media | Hub Dashboard",
};
      ...
      photos: [
        {
          ...
          url: "https://placehold.co/800x600/0D9488/FFFFFF?text=Exterior+Detail",
        ...
        },
        {
          ...
          company_id: "00000000-0000-0000-0000-000000000001",
          url: "https://placehold.co/800x600/0D9488/FFFFFF?text=Ceramic+Coating",
        ...
        },
        {
          ...
          company_id: "00000000-0000-0000-0000-000000000001",
          url: "https://placehold.co/800x600/0D9488/FFFFFF?text=Interior+Restore",
...
export default async function MediaPage() {
  ...
  return (
    <SectionCard
      title="Photos & Media"
      description="Upload photos to showcase your detailing work to the community."
    >
