...
export const metadata: Metadata = {
  title: "Edit Profile | Hub Dashboard",
};
  ...
  try {
    ...
    return {
      company: {
        ...
        description:
          "SkyShine Aviation Detailing is a premium aircraft detailing company serving the greater Miami area since 2012.",
  ...
  if (!company) {
    return (
      <div className="rounded-2xl border border-teal-100 bg-white py-16 text-center">
        <p className="text-gray-500 font-body">No company linked to your account.</p>
      </div>
    );
  }
