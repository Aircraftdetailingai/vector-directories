    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-full bg-teal-600 px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-teal-700 disabled:cursor-not-allowed disabled:opacity-50 font-body"
        >
            ...
            >
              <div>
                <div className="flex items-center gap-2">
                  ...
                  {loc.is_headquarters && (
                    <span className="rounded-full bg-coral-100 px-2 py-0.5 text-[10px] font-semibold text-coral-700">
                      HQ
                    </span>
                  )}
                </div>
                ...
                {loc.phone && (
                  <p className="mt-0.5 text-sm text-gray-400 font-body">{loc.phone}</p>
                )}
              </div>
