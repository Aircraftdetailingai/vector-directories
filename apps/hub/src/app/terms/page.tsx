...
export const metadata: Metadata = {
  title: "Terms of Service | Aviation Detailing Hub",
  description:
    "Read the Terms of Service for Aviation Detailing Hub.",
};
        ...
        <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 space-y-10 text-gray-700 leading-relaxed">
            <section>
              ...
              <p className="mt-3">
                By accessing or using Aviation Detailing Hub
                (aviationdetailinghub.com), you agree to be bound by these Terms
            ...
            <section>
              ...
              <p className="mt-3">
                Aviation Detailing Hub is an online directory and community
                platform that connects aircraft owners with professional
                detailing service providers. We provide listing pages, search
                functionality, and related tools to facilitate discovery and
            ...
            <section>
              ...
              <p className="mt-3">
                ...
                the accuracy of the information provided. Aviation Detailing Hub
                does not verify the qualifications, certifications, or quality
            ...
            <section>
              ...
              <p className="mt-3">
                All content, design, graphics, logos, and software on Aviation
                Detailing Hub are the property of Aviation Detailing Hub or its
            ...
            <section>
              ...
              <p className="mt-3">
                Aviation Detailing Hub is provided on an &ldquo;as is&rdquo; and
            ...
            <section>
              ...
              <p className="mt-3">
                ...
                Your continued use of Aviation Detailing Hub after changes are
