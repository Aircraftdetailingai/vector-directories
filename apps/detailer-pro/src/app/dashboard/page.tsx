...
export const metadata: Metadata = {
  title: "Pro Dashboard | Aircraft Detailer Pro",
};
...
async function getCompany(): Promise<Company | null> {
  try {
    ...
    return {
      ...
      description: "AeroShine Detailing Group delivers elite aircraft detailing services.",
...
export default async function DashboardOverviewPage() {
  ...
  if (!company) {
    return (
      <div className="rounded-lg border border-slate-700 bg-slate-800 py-16 text-center">
        <svg
        ...
        <Link
          href="/search"
          className="mt-4 inline-block text-sm font-semibold text-electric-400 transition-colors hover:text-electric-300"
        >
  ...
  return (
    <div className="space-y-6">
      {/* Pro verified listing card */}
      <div className="rounded-lg border border-electric-500/30 bg-electric-500/5 p-6">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-heading text-sm font-semibold text-electric-400">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="rounded-lg border border-slate-700 bg-slate-800 p-5">
          ...
          <p className="mt-1 text-sm text-slate-400">Trust Score</p>
        </div>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <Link
          ...
          className="group rounded-lg border border-slate-700 bg-slate-800 p-6 transition-all hover:border-electric-500/50"
        >
          <svg
            className="h-8 w-8 text-electric-500"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            strokeWidth={1.5}
          ...
          <h3 className="mt-4 font-heading text-sm font-semibold text-white group-hover:text-electric-400">
            View Public Profile
          </h3>
          <p className="mt-1 text-sm text-slate-400">
