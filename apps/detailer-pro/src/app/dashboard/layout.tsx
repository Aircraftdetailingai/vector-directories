  ...
  try {
    ...
    return {
      userProfile: {
        ...
        email: "marcus@aeroshine-example.com",
      ...
      company: {
        ...
        description:
          "AeroShine Detailing Group delivers elite aircraft detailing services.",
  ...
  return (
    <div className="flex min-h-screen flex-col bg-slate-950">
      ...
      <div className="flex-1">
        {/* Hero */}
        <section className="border-b border-slate-800 bg-slate-800 py-8">
