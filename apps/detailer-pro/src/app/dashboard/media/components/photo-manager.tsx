  ...
  if (maxPhotos === 0) {
    return (
      <div className="rounded-lg border border-dashed border-slate-700 bg-slate-900 py-16 text-center">
        ...
        <h3 className="mt-4 font-heading text-sm font-semibold text-slate-300">
          Photo Gallery
        </h3>
        ...
        <a
          ...
          className="mt-4 inline-block rounded-lg bg-electric-500 px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-electric-600"
        >
          View Plans
        </a>
      </div>
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end">
            ...
            <div className="flex-1">
              ...
              <input
                ...
                className="mt-1 w-full rounded-lg border border-slate-700 bg-slate-900 px-3 py-2 text-sm text-white placeholder:text-slate-500 focus:border-electric-500 focus:outline-none focus:ring-1 focus:ring-electric-500"
              />
            </div>
            <button
              type="submit"
              disabled={isPending}
              className="flex-shrink-0 rounded-lg bg-electric-500 px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-electric-600 disabled:opacity-50"
            >
            ...
            >
              ...
              >
                ...
                <button
                  type="submit"
                  disabled={isPending}
                  className="rounded-lg bg-slate-900/90 p-1.5 text-red-400 shadow-sm transition-colors hover:bg-red-500/20"
                  title="Delete photo"
                >
                  <svg
                    className="h-4 w-4"
