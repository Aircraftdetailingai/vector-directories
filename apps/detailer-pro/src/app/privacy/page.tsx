...
export const metadata: Metadata = {
  title: "Privacy Policy | Aircraft Detailer Pro",
  description:
    "Learn how Aircraft Detailer Pro collects, uses, and protects your personal information.",
};
        ...
        <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 space-y-10 text-gray-700 leading-relaxed">
            <section>
              ...
              <p className="mt-3">
                When you use Aircraft Detailer Pro (aircraftdetailerpro.com), we
