...
export const metadata: Metadata = {
  title: "Advertise With Us | Aircraft Detailer Pro",
  description:
    "Reach aircraft detailing decision-makers. Advertise on Aircraft Detailer Pro.",
};
          ...
          <div className="mx-auto grid max-w-4xl grid-cols-1 gap-8 px-4 sm:grid-cols-3 sm:px-6 lg:px-8">
            {STATS.map((stat) => (
              <div key={stat.label} className="text-center">
                <p className="font-heading text-3xl font-bold text-electric-500">
                  {stat.value}
                </p>
          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {PLACEMENTS.map((p) => (
                <div
                  key={p.type}
                  className="flex flex-col rounded-lg border border-slate-700 bg-slate-800 p-6 transition-colors hover:border-electric-500/50"
                >
                  <h3 className="font-heading text-lg font-bold text-white">
                    {p.name}
                  </h3>
                  <p className="mt-1 text-2xl font-bold text-electric-500">
                    {p.price}
                  </p>
                  ...
                  <Link
                    ...
                    className="mt-6 block rounded-lg bg-electric-500 px-4 py-2.5 text-center text-sm font-semibold text-white transition-colors hover:bg-electric-600"
                  >
                    Get Started
                  </Link>
                </div>
        ...
        <section className="bg-slate-950 py-16">
          <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
            ...
            <Link
              ...
              className="mt-8 inline-block rounded-lg bg-electric-500 px-8 py-3 text-sm font-semibold text-white transition-colors hover:bg-electric-600"
            >
              Get Started Now
            </Link>
          </div>
