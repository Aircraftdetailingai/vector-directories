...
export const metadata: Metadata = {
  title: "Privacy Policy | Aircraft Detailer Near Me",
  description:
    "Learn how Aircraft Detailer Near Me collects, uses, and protects your personal information.",
};
        ...
        <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 space-y-10 text-gray-700 leading-relaxed">
            <section>
              ...
              <p className="mt-3">
                When you use Aircraft Detailer Near Me
                (aircraftdetailernearme.com), we may collect the following types
                of information:
              </p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-brown-900">Cookies</h2>
              <p className="mt-3">
