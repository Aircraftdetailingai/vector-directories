...
export const metadata: Metadata = {
  title: "Advertise With Us | Aircraft Detailer Near Me",
  description:
    "Reach aircraft detailing decision-makers. Advertise on Aircraft Detailer Near Me.",
};
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        {/* Hero */}
        <section className="bg-brown-500 py-16 sm:py-24">
        ...
        {/* Stats */}
        <section className="border-b border-brand-100 bg-cream-50 py-12">
        ...
        <section className="bg-cream-50 py-16">
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            <h2 className="font-heading text-center text-2xl font-bold text-brown-500">
            ...
            <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {PLACEMENTS.map((p) => (
                <div
                  key={p.type}
                  className="flex flex-col rounded-xl border border-brand-100 bg-white p-6 shadow-sm transition-shadow hover:shadow-md"
                >
                  <h3 className="font-heading text-lg font-bold text-brown-500">
                    {p.name}
                  </h3>
                  ...
                  <Link
                    ...
                    className="mt-6 block rounded-xl bg-brand-500 px-4 py-2.5 text-center text-sm font-semibold text-white transition-colors hover:bg-brand-600"
                  >
                    Get Started
                  </Link>
                </div>
        ...
        <section className="bg-white py-16">
          <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            ...
            <dl className="mt-10 space-y-8">
              {FAQS.map((faq) => (
                <div key={faq.q}>
                  <dt className="font-heading text-base font-semibold text-brown-900">
                    {faq.q}
                  </dt>
        ...
        <section className="bg-brand-500 py-16">
          <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
            ...
            <Link
              ...
              className="mt-8 inline-block rounded-xl bg-white px-8 py-3 text-sm font-semibold text-brand-500 transition-colors hover:bg-cream-50"
            >
              Get Started Now
            </Link>
          </div>
