    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-xl bg-brand-500 px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-brand-600 disabled:cursor-not-allowed disabled:opacity-50"
        >
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-2">
            ...
            <div className="flex items-center gap-2 self-end">
              <input
                ...
                type="checkbox"
                className="h-4 w-4 rounded border-brand-200 bg-white text-brand-500 focus:ring-brand-500"
              />
              <label
                htmlFor="loc-hq"
            ...
            >
              <div>
                <div className="flex items-center gap-2">
                  ...
                  {loc.is_headquarters && (
                    <span className="rounded-xl bg-brand-50 px-2 py-0.5 text-[10px] font-semibold text-brand-500">
                      HQ
                    </span>
                  )}
                </div>
                ...
                {loc.phone && (
                  <p className="mt-0.5 text-sm text-gray-500">{loc.phone}</p>
                )}
              </div>
