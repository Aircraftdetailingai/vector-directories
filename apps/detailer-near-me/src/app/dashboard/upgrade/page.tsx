...
export const metadata: Metadata = {
  title: "Upgrade Plan | Dashboard | Aircraft Detailer Near Me",
};
...
export default async function UpgradePage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="font-heading text-xl font-bold text-brown-500">
          Choose Your Plan
        </h2>
        <p className="mt-1 text-sm text-gray-600">
          Unlock more features and grow your visibility to aircraft owners.
        </p>
      </div>
