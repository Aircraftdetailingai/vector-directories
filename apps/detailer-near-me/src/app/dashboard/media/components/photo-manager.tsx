...
export default function PhotoManager({
  ...
  if (maxPhotos === 0) {
    return (
      <div className="rounded-xl border border-dashed border-brand-200 bg-cream-50 py-16 text-center">
        <svg
        ...
        <h3 className="mt-4 font-heading text-sm font-semibold text-brown-500">
          Photo Gallery
        </h3>
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end">
            ...
            <div className="flex-1">
              ...
              <input
                ...
                className="mt-1 w-full rounded-xl border border-brand-200 bg-white px-3 py-2 text-sm text-gray-700 placeholder-gray-400 focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500"
              />
            </div>
            <button
              type="submit"
              disabled={isPending}
              className="flex-shrink-0 rounded-xl bg-brand-500 px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-brand-600 disabled:opacity-50"
            >
            ...
            >
              ...
              >
                ...
                <button
                  type="submit"
                  disabled={isPending}
                  className="rounded-xl bg-white/90 p-1.5 text-red-600 shadow-sm transition-colors hover:bg-red-50"
                  title="Delete photo"
                >
                  <svg
                    className="h-4 w-4"
