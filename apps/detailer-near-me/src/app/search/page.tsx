...
export const metadata: Metadata = {
  title: "Search Detailers | Aircraft Detailer Near Me",
  description:
    "Search for aircraft detailing services across the United States. Filter by state, service type, and compare trust scores.",
};
    ...
    <div className="flex min-h-screen flex-col bg-cream-50">
      ...
      <main className="flex-1">
        ...
        <section className="mx-auto max-w-7xl px-4 pt-6 sm:px-6 lg:px-8">
          <div className="rounded-xl bg-brand-500 px-6 py-10 text-white sm:px-10 sm:py-12">
