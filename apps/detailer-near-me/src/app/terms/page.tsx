...
export const metadata: Metadata = {
  title: "Terms of Service | Aircraft Detailer Near Me",
  description:
    "Read the Terms of Service for Aircraft Detailer Near Me.",
};
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1 bg-gray-50">
        <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
          <h1 className="font-heading text-3xl font-bold text-brown-900">
            Terms of Service
          </h1>
          ...
          <div className="mt-10 space-y-10 text-gray-700 leading-relaxed">
            <section>
              ...
              <p className="mt-3">
                By accessing or using Aircraft Detailer Near Me
                (aircraftdetailernearme.com), you agree to be bound by these
            ...
            <section>
              ...
              <p className="mt-3">
                Aircraft Detailer Near Me is an online directory platform that
                connects aircraft owners with professional detailing service
                providers in their area. We provide listing pages, location-based
                search functionality, and related tools to facilitate discovery
                and communication between users and businesses.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-3">
                ...
                the accuracy of the information provided. Aircraft Detailer Near
                Me does not verify the qualifications, certifications, or quality
                of listed service providers. Users are encouraged to conduct
                their own due diligence before engaging any service provider
            ...
            <section>
              ...
              <p className="mt-3">
                ...
                Detailer Near Me are the property of Aircraft Detailer Near Me or
                its licensors and are protected by intellectual property laws.
                You may not reproduce, distribute, or create derivative works
                from any content on the platform without prior written
                permission.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-3">
                Aircraft Detailer Near Me is provided on an &ldquo;as
            ...
            <section>
              ...
              <p className="mt-3">
                ...
                Your continued use of Aircraft Detailer Near Me after changes
                are posted constitutes your acceptance of the revised terms.
              </p>
            </section>

            <section>
              <h2 className="text-xl font-semibold text-brown-900">Contact</h2>
              <p className="mt-3">
