...
export default function CompanyContact({ company, location }: CompanyContactProps) {
  const hasAnyContact =
      ...
      <dl className="mt-4 space-y-4">
        {company.phone && (
          <div className="flex items-start gap-3">
            <dt>
              <svg
                className="mt-0.5 h-5 w-5 text-brand-500"
                fill="none"
                viewBox="0 0 24 24"
                strokeWidth={1.5}
                stroke="currentColor"
          ...
          <div className="flex items-start gap-3">
            ...
            <dd>
              <a
                ...
                className="text-sm text-brand-500 underline decoration-brand-200 transition-colors hover:text-brand-600 hover:decoration-brand-400"
              >
                Visit Website
              </a>
            </dd>
