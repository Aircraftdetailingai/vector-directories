  ...
  if (step === "done") {
    return (
      <div className="rounded-xl border border-green-200 bg-green-50 p-8 text-center">
        ...
        <h3 className="mt-4 font-heading text-lg font-semibold text-green-700">
          Listing Claimed!
        </h3>
    ...
    return (
      <div className="rounded-xl border border-brand-100 bg-white p-6 sm:p-8">
        ...
        <form action={handleVerify} className="mt-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-xl border border-brand-200 bg-white px-4 py-3 text-center font-heading text-2xl font-bold tracking-[0.3em] text-gray-700 placeholder-gray-400 focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500"
            />
          </div>
          ...
          <button
            type="submit"
            disabled={isPending}
            className="w-full rounded-xl bg-brand-500 px-4 py-3 text-sm font-semibold text-white transition-colors hover:bg-brand-600 disabled:cursor-not-allowed disabled:opacity-50"
          >
        ...
        <button
          ...
          className="mt-4 text-sm text-gray-500 transition-colors hover:text-brand-500"
        >
      ...
      <form action={handleSendCode} className="mt-6 space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className="w-full rounded-xl border border-brand-200 bg-white px-4 py-3 text-sm text-gray-700 placeholder-gray-400 focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500"
          />
        </div>
