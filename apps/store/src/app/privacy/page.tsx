...
export const metadata: Metadata = {
  title: "Privacy Policy | Aircraft Detailing 101",
  description:
    "Learn how Aircraft Detailing 101 collects, uses, and protects your personal information.",
};
        ...
        <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 space-y-8 text-gray-700 leading-relaxed">
            <section>
              ...
              <p className="mt-3">
                Aircraft Detailing 101 (&quot;we,&quot; &quot;us,&quot; or
                &quot;our&quot;) operates the website aircraftdetailing101.com.
            ...
            <section>
              ...
              <ul className="mt-3 list-disc space-y-2 pl-6">
                <li>
                  ...
                  address, billing information, and other contact information
                  you voluntarily provide when making a purchase, creating an
                  account, or using our contact form.
                </li>
                <li>
                  <strong>Transaction Data:</strong> Purchase history, payment
                  method details (processed securely through our payment
            ...
            <section>
              ...
              <ul className="mt-3 list-disc space-y-2 pl-6">
                <li>
                  ...
                  such as payment processing, shipping, hosting, analytics, and
                  email delivery.
                </li>
                <li>
