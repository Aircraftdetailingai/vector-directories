...
export const metadata: Metadata = {
  title: "Advertise With Us | Aircraft Detailing Authority",
  description:
    "Reach aircraft detailing decision-makers. Advertise on Aircraft Detailing Authority.",
};
      ...
      <main className="flex-1">
        ...
        <section className="bg-navy-900 py-16 sm:py-24">
          <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
            <h1 className="font-heading text-4xl font-bold text-gold-500 sm:text-5xl">
              Advertise With Us
            </h1>
        ...
        <section className="bg-gray-50 py-16">
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            <h2 className="font-heading text-center text-2xl font-bold text-navy-900">
            ...
            <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {PLACEMENTS.map((p) => (
                <div
                  key={p.type}
                  className="flex flex-col rounded border border-gray-200 bg-white p-6 shadow-sm transition-shadow hover:shadow-md"
                >
                  ...
                  <Link
                    ...
                    className="mt-6 block rounded bg-gold-500 px-4 py-2.5 text-center text-sm font-semibold text-navy-900 transition-colors hover:bg-gold-600"
                  >
                    Get Started
                  </Link>
                </div>
        ...
        <section className="bg-white py-16">
          <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            ...
            <dl className="mt-10 space-y-8">
              {FAQS.map((faq) => (
                <div key={faq.q}>
                  <dt className="font-heading text-base font-semibold text-navy-900">
                    {faq.q}
                  </dt>
        ...
        <section className="bg-navy-900 py-16">
          <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
            <h2 className="font-heading text-3xl font-bold text-gold-500">
            ...
            <Link
              ...
              className="mt-8 inline-block rounded bg-gold-500 px-8 py-3 text-sm font-semibold text-navy-900 transition-colors hover:bg-gold-600"
            >
              Get Started Now
            </Link>
          </div>
