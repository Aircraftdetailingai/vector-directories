    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1 bg-gray-50">
        <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="mt-4 font-heading text-3xl font-bold text-navy-900">
          ...
          <div className="mt-10 grid gap-10 lg:grid-cols-2">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="mt-1 block w-full rounded border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-gold-500 focus:outline-none focus:ring-1 focus:ring-gold-500"
                  />
                </div>
                ...
                <button
                  type="submit"
                  className="w-full rounded bg-gold-500 px-4 py-3 text-sm font-semibold text-navy-900 transition-colors hover:bg-gold-600"
                >
                  Continue to Payment
                </button>
              </div>
            ...
            <div>
              ...
              <div className="mt-4 rounded border border-gray-200 bg-white p-4">
                <div className="flex aspect-[728/90] items-center justify-center rounded bg-navy-50 text-sm text-navy-400">
                  {imageUrl ? (
                    <img
                      src={imageUrl}
                      alt="Ad preview"
