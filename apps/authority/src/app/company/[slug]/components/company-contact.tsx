      ...
      <div className="space-y-4">
        ...
        {company.phone && (
          <div className="flex items-center gap-3">
            ...
            <a
              ...
              className="text-sm text-navy-700 hover:text-navy-900 transition-colors font-body"
            >
        ...
        {company.email && (
          <div className="flex items-center gap-3">
            ...
            <a
              ...
              className="text-sm text-navy-700 hover:text-navy-900 transition-colors font-body break-all"
            >
              {company.email}
            </a>
          </div>
        ...
        {hq && (
          <div className="flex items-start gap-3">
            <MapPinIcon />
            <div className="text-sm text-navy-700 font-body">
              <p className="font-medium text-navy-800">{hq.name}</p>
              <p>{formatAddress(hq)}</p>
            </div>
          </div>
        )}
      </div>
