...
export const metadata: Metadata = {
  title: "Terms of Service | Aircraft Detailing Authority",
  description:
    "Terms of Service for Aircraft Detailing Authority. Please read these terms carefully before using our services.",
};
          ...
          <div className="mt-10 space-y-10 text-gray-700">
            <section>
              ...
              <p className="mt-3 leading-relaxed">
                By accessing or using Aircraft Detailing Authority at
                aircraftdetailingauthority.com, you agree to be bound by these
            ...
            <section>
              ...
              <p className="mt-3 leading-relaxed">
                Aircraft Detailing Authority is a directory listing service for
            ...
            <section>
              ...
              <p className="mt-3 leading-relaxed">
                Some features of Aircraft Detailing Authority may require you to
            ...
            <section>
              ...
              <p className="mt-3 leading-relaxed">
                ...
                Aircraft Detailing Authority does not verify the accuracy of
            ...
            <section>
              ...
              <p className="mt-3 leading-relaxed">
                You agree not to use Aircraft Detailing Authority for any
            ...
            <section>
              ...
              <p className="mt-3 leading-relaxed">
                ...
                Authority, including but not limited to text, graphics, logos,
                and software, are the property of Aircraft Detailing Authority or
            ...
            <section>
              ...
              <p className="mt-3 leading-relaxed">
                Aircraft Detailing Authority is provided on an &quot;as
                is&quot; and &quot;as available&quot; basis. To the fullest
                extent permitted by law, we disclaim all warranties and shall not
            ...
            <section>
              ...
              <p className="mt-3 leading-relaxed">
                ...
                Aircraft Detailing Authority at our sole discretion, without
            ...
            <section>
              ...
              <p className="mt-3 leading-relaxed">
                ...
                aircraftdetailingauthority.com. Your continued use of Aircraft
                Detailing Authority after any changes constitutes your acceptance
