...
export const metadata: Metadata = {
  title: "Privacy Policy | Aircraft Detailing Authority",
  description:
    "Privacy Policy for Aircraft Detailing Authority. Learn how we collect, use, and protect your information.",
};
          ...
          <div className="mt-10 space-y-10 text-gray-700">
            <section>
              ...
              <p className="mt-3 leading-relaxed">
                When you use Aircraft Detailing Authority, we may collect
            ...
            <section>
              ...
              <p className="mt-3 leading-relaxed">
                ...
                relevant communications about Aircraft Detailing Authority, and
                maintain the security and functionality of our platform at
                aircraftdetailingauthority.com.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-3 leading-relaxed">
                Aircraft Detailing Authority uses standard cookies to ensure the
