...
export const metadata: Metadata = {
  title: "Owner Dashboard | Aircraft Detailing Near Me",
};
  ...
  if (!company) {
    return (
      <div className="rounded-xl border border-gray-200 bg-white py-16 text-center">
        ...
        <Link
          href="/search"
          className="mt-4 inline-block text-sm font-semibold text-sky-600 transition-colors hover:text-sky-500"
        >
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-sky-200 bg-sky-50 p-6">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-heading text-sm font-semibold text-sky-800">
            Your Verified Listing
          </h2>
        </div>
        <p className="mt-2 font-heading text-xl font-bold text-sky-900">
          {company.name}
        </p>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <Link
          ...
          className="group rounded-xl border border-gray-200 bg-white p-6 transition-all hover:border-sky-300 hover:shadow-lg hover:shadow-sky-100/50"
        >
          <svg
          ...
          <h3 className="mt-4 font-heading text-sm font-semibold text-gray-900 group-hover:text-sky-700">
            View Public Profile
          </h3>
          <p className="mt-1 text-sm text-gray-500">
