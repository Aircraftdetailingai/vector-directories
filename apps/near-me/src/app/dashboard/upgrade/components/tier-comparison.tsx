          ...
          <tbody className="divide-y divide-gray-100 bg-white">
                  ...
                  return (
                    <td
                      ...
                      className={`px-6 py-3 text-center text-sm ${
                        t.key === currentTier ? "bg-sky-50/50" : ""
                      } ${val === "Yes" ? "font-semibold text-emerald-600" : val === "\u2014" ? "text-gray-300" : "text-gray-700"}`}
                    >
                      {val}
                    </td>
                  );
            ...
            <tr>
              ...
              {TIERS.map((t) => (
                <td
                  key={t.key}
                  className={`px-6 py-4 text-center ${t.key === currentTier ? "bg-sky-50/50" : ""}`}
                >
                  {t.key === "basic" ? (
                    t.key === currentTier ? (
                ...
                {FEATURE_ROWS.map((row) => {
                  ...
                  return (
                    <div key={row.label} className="flex justify-between">
                      ...
                      <dd
                        className={`text-sm font-medium ${val === "Yes" ? "text-emerald-600" : val === "\u2014" ? "text-gray-300" : "text-gray-700"}`}
                      >
                        {val}
                      </dd>
                    </div>
