  ...
  if (step === "done") {
    return (
      <div className="rounded-xl border border-emerald-200 bg-emerald-50 p-8 text-center">
        ...
        <h3 className="mt-4 font-heading text-lg font-semibold text-emerald-800">
          Listing Claimed!
        </h3>
    ...
    return (
      <div className="rounded-xl border border-gray-200 bg-white p-6 sm:p-8">
        ...
        <form action={handleVerify} className="mt-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-gray-200 px-4 py-3 text-center font-heading text-2xl font-bold tracking-[0.3em] text-gray-900 placeholder:text-gray-300 focus:border-sky-500 focus:outline-none focus:ring-2 focus:ring-sky-50"
            />
          </div>
          ...
          <button
            type="submit"
            disabled={isPending}
            className="w-full rounded-lg bg-sky-500 px-4 py-3 text-sm font-semibold text-white transition-colors hover:bg-sky-600 disabled:cursor-not-allowed disabled:opacity-50"
          >
        ...
        <button
          ...
          className="mt-4 text-sm text-gray-500 transition-colors hover:text-sky-600"
        >
      ...
      <form action={handleSendCode} className="mt-6 space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className="w-full rounded-lg border border-gray-200 px-4 py-3 text-sm text-gray-700 placeholder:text-gray-400 focus:border-sky-500 focus:outline-none focus:ring-2 focus:ring-sky-50"
          />
        </div>
