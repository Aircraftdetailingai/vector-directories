...
export const metadata: Metadata = {
  title: "Advertiser Dashboard | Aircraft Detailing Near Me",
  description: "Manage your ads on Aircraft Detailing Near Me.",
};
      ...
      <main className="flex-1 bg-gray-50">
        <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <Link
              href="/advertise"
              className="rounded-full bg-sky-500 px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-sky-600"
            >
              Create New Ad
            </Link>
          </div>
          ...
          <div className="mt-8 overflow-hidden rounded-lg border border-gray-200 bg-white">
            {ads.length === 0 ? (
              <div className="p-12 text-center">
                ...
                <Link
                  href="/advertise"
                  className="mt-4 inline-block rounded-full bg-sky-500 px-6 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-sky-600"
                >
