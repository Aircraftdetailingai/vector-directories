...
export const metadata: Metadata = {
  title: "Advertise With Us | Aircraft Detailing Near Me",
  description:
    "Reach aircraft detailing decision-makers. Advertise on Aircraft Detailing Near Me.",
};
      ...
      <main className="flex-1">
        ...
        <section className="bg-gray-50 py-16">
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            <h2 className="font-heading text-center text-2xl font-bold text-gray-900">
              ...
              {PLACEMENTS.map((p) => (
                ...
                >
                  ...
                  <Link
                    ...
                    className="mt-6 block rounded-full bg-sky-500 px-4 py-2.5 text-center text-sm font-semibold text-white transition-colors hover:bg-sky-600"
                  >
                    Get Started
                  </Link>
                </div>
        ...
        <section className="bg-sky-500 py-16">
          <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
            ...
            <Link
              ...
              className="mt-8 inline-block rounded-full bg-white px-8 py-3 text-sm font-semibold text-sky-600 transition-colors hover:bg-gray-100"
            >
              Get Started Now
            </Link>
          </div>
