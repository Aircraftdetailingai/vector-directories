          ...
          <div className="mt-10 grid gap-10 lg:grid-cols-2">
            ...
            <form action={startAdCheckout}>
              ...
              <div className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full rounded-full bg-sky-500 px-4 py-3 text-sm font-semibold text-white transition-colors hover:bg-sky-600"
                >
                  Continue to Payment
                </button>
              </div>
            ...
            <div>
              ...
              <div className="mt-4 rounded-lg border border-gray-200 bg-white p-4">
                <div className="flex aspect-[728/90] items-center justify-center rounded-lg bg-sky-50 text-sm text-sky-500">
                  {imageUrl ? (
                    <img
                      src={imageUrl}
                      alt="Ad preview"
