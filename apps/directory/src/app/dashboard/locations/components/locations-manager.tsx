    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-lg bg-forest-800 px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-forest-700 disabled:cursor-not-allowed disabled:opacity-50"
        >
      ...
      {showForm && (
        ...
        >
          ...
          <h3 className="font-heading text-sm font-semibold text-forest-800">
            New Location
          </h3>
