...
export const metadata: Metadata = {
  title: "Owner Dashboard | Aircraft Detailing Directory",
};
  ...
  if (!company) {
    return (
      <div className="rounded-xl border border-gray-200 bg-white py-16 text-center">
        ...
        <Link
          href="/search"
          className="mt-4 inline-block text-sm font-semibold text-forest-700 transition-colors hover:text-forest-600"
        >
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-forest-200 bg-forest-50 p-6">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-heading text-sm font-semibold text-forest-800">
            Your Verified Listing
          </h2>
        </div>
        <p className="mt-2 font-heading text-xl font-bold text-forest-900">
          {company.name}
        </p>
        <p className="mt-1 text-sm text-forest-600">
          Tier:{" "}
          <span className="font-semibold capitalize">{company.tier}</span>
          {" "}&middot; Trust Score: {company.trust_score ?? "N/A"}
        </p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        <div className="rounded-xl border border-gray-200 bg-white p-5">
          ...
          <p className="mt-1 text-sm text-gray-500">
            ...
            <span className="text-gray-400">/ {features.maxLocations === Infinity ? "Unlimited" : features.maxLocations}</span>
          </p>
        </div>
        <div className="rounded-xl border border-gray-200 bg-white p-5">
          <p className="text-2xl font-bold text-forest-800">
          ...
          <p className="mt-1 text-sm text-gray-500">
            ...
            <span className="text-gray-400">/ {features.maxPhotos === Infinity ? "Unlimited" : features.maxPhotos}</span>
          </p>
        </div>
        <div className="rounded-xl border border-gray-200 bg-white p-5">
          <p className="text-2xl font-bold text-forest-800">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <Link
          ...
          className="group rounded-xl border border-gray-200 bg-white p-6 transition-all hover:border-forest-300 hover:shadow-lg hover:shadow-forest-100/50"
        >
          <svg
          ...
          <h3 className="mt-4 font-heading text-sm font-semibold text-gray-900 group-hover:text-forest-700">
            View Public Profile
          </h3>
          <p className="mt-1 text-sm text-gray-500">
