...
export function PhotoManager({ photos, companyId, tier }: PhotoManagerProps) {
  ...
  // Free tier (maxPhotos=0) — show upsell
  if (maxPhotos === 0) {
    return (
      <div className="rounded-xl border border-dashed border-gray-300 bg-gray-50 py-16 text-center">
        ...
        <p className="mt-2 text-sm text-gray-500">
          Upgrade to Starter or above to showcase photos of your work.
        </p>
        <a
          href="/dashboard/upgrade"
          className="mt-4 inline-block rounded-lg bg-forest-800 px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-forest-700"
        >
          View Plans
        </a>
      </div>
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end">
            ...
            <div className="flex-1">
              ...
              <input
                ...
                className="mt-1 w-full rounded-lg border border-gray-200 px-3 py-2 text-sm text-gray-700 focus:border-forest-500 focus:outline-none focus:ring-1 focus:ring-forest-500"
              />
            </div>
            <button
              type="submit"
              disabled={isPending}
              className="flex-shrink-0 rounded-lg bg-forest-800 px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-forest-700 disabled:opacity-50"
            >
