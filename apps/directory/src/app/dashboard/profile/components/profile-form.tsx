...
export function ProfileForm({ company, socialLinks }: ProfileFormProps) {
  ...
  return (
    <form action={handleSubmit} className="space-y-6">
      ...
      {result?.success && (
        <p className="text-sm text-forest-600">Profile updated successfully.</p>
      )}
      ...
      <div className="flex justify-end">
        <button
          type="submit"
          disabled={isPending}
          className="rounded-lg bg-forest-800 px-6 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-forest-700 disabled:cursor-not-allowed disabled:opacity-50"
        >
