...
function CheckoutForm() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <h1 className="mt-4 font-heading text-3xl font-bold text-forest-800">
      ...
      <div className="mt-10 grid gap-10 lg:grid-cols-2">
          ...
          <div className="space-y-6">
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full rounded-lg border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-forest-500 focus:outline-none focus:ring-1 focus:ring-forest-500"
              />
            </div>
            ...
            <button
              type="submit"
              className="w-full rounded-lg bg-forest-800 px-4 py-3 text-sm font-semibold text-white transition-colors hover:bg-forest-700"
            >
              Continue to Payment
            </button>
          </div>
        ...
        {/* Preview */}
        <div>
          <h2 className="font-heading text-lg font-semibold text-forest-800">
            Ad Preview
          </h2>
          <div className="mt-4 rounded-lg border border-gray-200 bg-white p-4">
            <div className="flex aspect-[728/90] items-center justify-center rounded bg-forest-50 text-sm text-forest-600">
              {imageUrl ? (
                <img
                  src={imageUrl}
                  alt="Ad preview"
