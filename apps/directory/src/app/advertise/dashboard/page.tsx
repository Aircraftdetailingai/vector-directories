...
export const metadata: Metadata = {
  title: "Advertiser Dashboard | Aircraft Detailing Directory",
  description: "Manage your ads on Aircraft Detailing Directory.",
};
      ...
      <main className="flex-1 bg-gray-50">
        <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <Link
              href="/advertise"
              className="rounded-lg bg-forest-800 px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-forest-700"
            >
              Create New Ad
            </Link>
          </div>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-3">
            <div className="rounded-lg border border-gray-200 bg-white p-6">
              ...
              <p className="mt-1 font-heading text-2xl font-bold text-forest-800">
          ...
          <div className="mt-8 overflow-hidden rounded-lg border border-gray-200 bg-white">
            {ads.length === 0 ? (
              <div className="p-12 text-center">
                ...
                <Link
                  href="/advertise"
                  className="mt-4 inline-block rounded-lg bg-forest-800 px-6 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-forest-700"
                >
