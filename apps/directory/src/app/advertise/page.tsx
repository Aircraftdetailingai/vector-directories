...
export const metadata: Metadata = {
  title: "Advertise With Us | Aircraft Detailing Directory",
  description:
    "Reach aircraft detailing decision-makers. Advertise on Aircraft Detailing Directory.",
};
      ...
      <main className="flex-1">
          ...
          <div className="mx-auto grid max-w-4xl grid-cols-1 gap-8 px-4 sm:grid-cols-3 sm:px-6 lg:px-8">
            {STATS.map((stat) => (
              <div key={stat.label} className="text-center">
                <p className="font-heading text-3xl font-bold text-forest-800">
                  {stat.value}
                </p>
        ...
        <section className="bg-gray-50 py-16">
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            <h2 className="font-heading text-center text-2xl font-bold text-forest-800">
            ...
            <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {PLACEMENTS.map((p) => (
                ...
                >
                  ...
                  <p className="mt-1 text-2xl font-bold text-forest-700">
                    {p.price}
                  </p>
                  ...
                  <Link
                    ...
                    className="mt-6 block rounded-lg bg-forest-800 px-4 py-2.5 text-center text-sm font-semibold text-white transition-colors hover:bg-forest-700"
                  >
                    Get Started
                  </Link>
                </div>
        ...
        <section className="bg-forest-800 py-16">
          <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
            ...
            <Link
              ...
              className="mt-8 inline-block rounded-lg bg-white px-8 py-3 text-sm font-semibold text-forest-800 transition-colors hover:bg-forest-100"
            >
              Get Started Now
            </Link>
          </div>
